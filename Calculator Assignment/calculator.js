...
function Handle_Operator(Next_Operator) {
    ...
    //Checks if an operaddtor already exists and if Wait_Second_Operand is true,
    ...
    if (First_Operand == null) {
        ...
        //If opsderator exists, property lookup is performed for the operator
...
Update_Display();
//This section monuitors button clicks
